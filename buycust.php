        ...
        <body background="images/buyback.jpg" style="background-size:cover;background-repeat: no-repeat;width:100%;height:100%">
            ...
            <form method="post" action="">
                <div id="sidebar" style="float:left;width:35%;background-color:white;">
                 <table class="three">
                    <tr><img style="margin-left:40px;" src="images/buyimg.jpg"></img></tr>
                    <tr class="buyterms"><th>Purpose    </th><th><input type="text" name="purpose" value="Purchase" readonly></th></tr>
                    ...
                    <tr class="buyterms"><th>Price      </th><th><select id="price" name="price">
                        <option value="select" disabled selected>select</option><option value="500000">&lt 5 Lakh</option><option value="1000000">&lt 10 lakh</option><option value="2500000">&lt 25 lakh</option><option value="5000000">&lt 50 lakh</option><option value="10000000">&lt 1 crore</option><option value="1000000000">&gt 1 crore</option>
                                                    </select></th></tr>
                                  ...
                                  ?>
                                   ...
                                   <div class="cards" style="margin-left:35px;">
                                      <table width="100%" style="background:white;border-color:#009B77">
                                          <tr>
                                              <th>
                                              <img src="images/<?php echo $row['img1']?>" style="width:400px;height:300px;" alt="" class="card__image">
                                  <th>
